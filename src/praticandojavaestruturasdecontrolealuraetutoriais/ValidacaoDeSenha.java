package praticandojavaestruturasdecontrolealuraetutoriais;//esta linha package define o pacote em que minha classe está localizada.Isso é usado para oragnizar minhas classes em grupos.O Scanner é uma classe que precisa ser importada para que você possa usá-la, e por isso deve ser adicionada com a linha import java.util.Scanner; O Scanner é uma classe que precisa ser importada para que eu possa usá-la, e por isso deve ser adicionada na linha seguinte.
